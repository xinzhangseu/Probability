...
% Restore the ElegantBook example environment after Quarto has created
% the example counter. Reuse that counter instead of declaring it again.
...
% Restore the ElegantBook exercise environment after Quarto has created
% the exercise counter. Reuse that counter instead of declaring it again.
