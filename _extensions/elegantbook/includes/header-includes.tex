...
%------------------------------------------------------------------------------
% 4b. Table of contents hierarchy
%------------------------------------------------------------------------------
% Chapter entries stay prominent; section entries are smaller and indented.
% Apply after all language and document-class customizations are loaded.
\AtBeginDocument{%
