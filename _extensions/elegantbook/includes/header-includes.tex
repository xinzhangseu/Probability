...
%------------------------------------------------------------------------------
% Example environment
% The original definition is retained below as comments. The active definition
% is moved to before-body.tex so it runs after Quarto's automatic theorem setup.
...
% Keep Quarto's CJK*font settings authoritative. Without fontset=none,
% ctex auto-selects platform-specific fonts and overrides _quarto.yml.
